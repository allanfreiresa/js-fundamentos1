//1 - Crie uma variável contendo uma frase. Em seguida, exiba no console 
//o comprimento da frase e a mesma frase em constras maiúsculas.
...
//2 - Declare duas variáveis, uma inicializada com valor null e outra que não 
//recebe atribuição (resultando em undefined). Exiba os valores no console.
...
//3 - Crie 3 variáveis de tipos diferentes, utilize template strings para 
//combinar os diferentes tipos de dados (number, string, boolean) em uma única string e exiba o resultado no console.
